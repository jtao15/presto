...
public class TestBackgroundHiveSplitLoader
{
            ...
            throws Exception
    {
        ...
        Tracer engineTracer = DefaultTracer.createBasicTracer(event -> tracerEvents.add(event), payloadMap -> jsonCodec.toJson(payloadMap), "node", URI.create("http://test.com"), "query", true);
