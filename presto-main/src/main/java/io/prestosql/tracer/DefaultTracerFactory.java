        ...
        implements TracerFactory
{
    ...
    {
        return DefaultTracer.createBasicTracer(event -> eventListenerManager.tracerEventOccurred(event), nodeInfo.getNodeId(), uri, queryId, isQueryDebuggingTracerEnabled(session));
    }
}
