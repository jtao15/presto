...
import io.prestosql.spi.tracer.NoOpConnectorTracerFactory;
...
public class ConnectorTracerManager
{
    ...
    public ConnectorTracerFactory getConnectorTracerFactory(CatalogName catalogName)
    {
        ConnectorTracerFactory tracerFactory = tracerFactories.get(catalogName);
        if (tracerFactory == null) {
            return new NoOpConnectorTracerFactory();
        }
