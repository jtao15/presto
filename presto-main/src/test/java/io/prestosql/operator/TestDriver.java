...
public class TestDriver
{
    ...
    public void testAddSourceFinish()
    {
        ...
        Tracer tracer = DefaultTracer.createBasicTracer(event -> tracerEvents.add(event), payloadMap -> jsonCodec.toJson(payloadMap), "node", URI.create("http://test.com"), "0", true);
