...
public class TestSqlTask
{
            ...
            implements TracerFactory
    {
        ...
        {
            return DefaultTracer.createBasicTracer(event -> this.tracerEvents.add(event), payloadMap -> jsonCodec.toJson(payloadMap), "node", URI.create("http://test.com"), queryId, true);
        }
    }
}
