...
public class TestTaskExecutor
{
            ...
            throws Exception
    {
        ...
        try {
            ...
            Tracer tracer = DefaultTracer.createBasicTracer(event -> tracerEvents.add(event), payloadMap -> jsonCodec.toJson(payloadMap), "node", URI.create("http://test.com"), "driver1", true);
