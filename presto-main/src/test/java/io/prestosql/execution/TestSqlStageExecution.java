...
public class TestSqlStageExecution
{
            ...
            throws Exception
    {
        ...
        Tracer tracer = DefaultTracer.createBasicTracer(event -> tracerEvents.add(event), payloadMap -> jsonCodec.toJson(payloadMap), "node", URI.create("http://test.com"), stageId.getQueryId().getId(), true).newTracerWithStageId(String.valueOf(stageId.getId()));
