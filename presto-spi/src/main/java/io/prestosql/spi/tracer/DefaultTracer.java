        ...
        implements Tracer
{
    ...
    public static Tracer createBasicTracer(Consumer<TracerEvent> emitter, String nodeId, URI uri, String queryId, boolean enabled)
    {
        return (new Builder(emitter, nodeId, uri, queryId, enabled)).build();
    }
    ...
    public void emitEvent(TracerEventTypeSupplier eventTypeSupplier, PayloadBuilder payloadBuilder)
    {
        ...
        TracerEvent event = new TracerEvent(
                ...
                payloadBuilder == null ? null : payloadBuilder.getPayload());
    ...
    private static class Builder
    {
        ...
        public Builder(Consumer<TracerEvent> emitter, String nodeId, URI uri, String queryId, boolean isEnabled)
        {
            this.emitter = requireNonNull(emitter, "emitter is null");
        ...
        public Tracer build()
        {
            return new DefaultTracer(emitter, nodeId, uri, queryId, stageId, taskId, pipelineId, splitId, operatorId, enabled);
        }
    }
}
